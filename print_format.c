 ...
 * @format: the format to print as per specifier
 ...
 * @prev_format: The previous byte to the actual specifier
 * @format: The specifier to print
 * @count: The curent count before prints invalid specifiers
 *
 * Return: The current count of printed invalid specifiers
 */
...
/**
 * _validate_char - validate the type of specifier
 * @_type: character to be validated and compared
 *
 * Return: 1 if char is equal to a valid type
 */
